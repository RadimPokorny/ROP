    ...
    !function(A, I) {
      ...
      return (() => {
        var A, I, g = { 773: (A2, I2, g2) => {
          ...
          for (B2 in Q2)
            Q2.hasOwnProperty(B2) && (C[B2] = Q2[B2]);
          var E, i, o, D, e = [];
          ...
          for (B2 in C)
            C.hasOwnProperty(B2) && (Q2[B2] = C[B2]);
          ...
          var m, X = { a: function(A3, I3, g3) {
            ...
            for (var Q3 = 1; Q3 <= 4; Q3 *= 2) {
              var C2 = g3 * (1 + 0.2 / Q3);
              if (C2 = Math.min(C2, A3 + 100663296), x(Math.min(B3, ((I3 = Math.max(A3, C2)) % 65536 > 0 && (I3 += 65536 - I3 % 65536), I3))))
                return true;
            }
            return false;
          } }, W = (function() {
              ...
              return function() {
                if (!F && (E || i)) {
                  if ("function" == typeof fetch && !L(K))
                    return fetch(K, { credentials: "same-origin" }).then(function(A4) {
                      if (!A4.ok)
                  ...
                  if (t)
                    return new Promise(function(A4, I5) {
                      t(K, function(I6) {
            ...
            if (d++, Q2.monitorRunDependencies && Q2.monitorRunDependencies(d), Q2.instantiateWasm)
              try {
              ...
              m || (m = true, Q2.calledRun = true, h || (b(S), Q2.onRuntimeInitialized && Q2.onRuntimeInitialized(), function() {
                if (Q2.postRun)
                  for ("function" == typeof Q2.postRun && (Q2.postRun = [Q2.postRun]); Q2.postRun.length; )
                    A4 = Q2.postRun.shift(), H.unshift(A4);
                var A4;
                b(H);
              }()));
            }
            A3 = A3 || e, d > 0 || (function() {
              if (Q2.preRun)
                for ("function" == typeof Q2.preRun && (Q2.preRun = [Q2.preRun]); Q2.preRun.length; )
                  A4 = Q2.preRun.shift(), Y.unshift(A4);
              var A4;
              b(Y);
          ...
          if (Q2.allocate = function(A3, I3) {
            ...
            return A3 ? function(A4, I4, g3) {
              for (var B3 = I4 + g3, Q3 = I4; A4[Q3] && !(Q3 >= B3); )
                ++Q3;
              if (Q3 - I4 > 16 && A4.subarray && f)
                return f.decode(A4.subarray(I4, Q3));
              for (var C2 = ""; I4 < Q3; ) {
                var E2 = A4[I4++];
                if (128 & E2) {
                  var i2 = 63 & A4[I4++];
                  if (192 != (224 & E2)) {
                    var o2 = 63 & A4[I4++];
                    if ((E2 = 224 == (240 & E2) ? (15 & E2) << 12 | i2 << 6 | o2 : (7 & E2) << 18 | i2 << 12 | o2 << 6 | 63 & A4[I4++]) < 65536)
                    ...
                    C2 += String.fromCharCode((31 & E2) << 6 | i2);
                } else
                  C2 += String.fromCharCode(E2);
              }
              return C2;
          ...
          "undefined" != typeof self && self, void 0 === (Q2 = "function" == typeof (B2 = function() {
            ...
            function B3(I4) {
              if (B3._promise)
                return B3._promise;
              if (B3._module)
                return Promise.resolve(B3._module);
              let C2;
            ...
            function i(A4) {
              ...
              if ("function" == typeof TextEncoder)
                return new TextEncoder().encode(A4);
              if ("function" == typeof Buffer)
                return Buffer.from(A4);
        ...
        return I = Object.getPrototypeOf ? (A2) => Object.getPrototypeOf(A2) : (A2) => A2.__proto__, Q.t = function(g2, B2) {
          if (1 & B2 && (g2 = this(g2)), 8 & B2)
            return g2;
          if ("object" == typeof g2 && g2) {
            if (4 & B2 && g2.__esModule)
              return g2;
            if (16 & B2 && "function" == typeof g2.then)
              return g2;
          }
          ...
          var E = {};
          A = A || [null, I({}), I([]), I(I)];
          for (var i = 2 & B2 && g2; "object" == typeof i && !~A.indexOf(i); i = I(i))
            Object.getOwnPropertyNames(i).forEach((A2) => E[A2] = () => g2[A2]);
          return E.default = () => g2, Q.d(C, E), C;
        }, Q.d = (A2, I2) => {
          for (var g2 in I2)
            Q.o(I2, g2) && !Q.o(A2, g2) && Object.defineProperty(A2, g2, { enumerable: true, get: I2[g2] });
