...
var require_argon2_bundled_min = __commonJS({
  "node_modules/argon2-browser/dist/argon2-bundled.min.js"(exports, module) {
    !function(A, I) {
      ...
      return (() => {
        var A, I, g = { 773: (A2, I2, g2) => {
          var B2, Q2 = "undefined" != typeof self && void 0 !== self.Module ? self.Module : {}, C = {};
          for (B2 in Q2) Q2.hasOwnProperty(B2) && (C[B2] = Q2[B2]);
          var E, i, o, D, e = [];
          ...
          var n, t, a, r, s, y = "";
          o ? (y = i ? g2(967).dirname(y) + "/" : "//", n = function(A3, I3) {
            return r || (r = g2(145)), s || (s = g2(967)), A3 = s.normalize(A3), r.readFileSync(A3, I3 ? null : "utf8");
          }, a = function(A3) {
            var I3 = n(A3, true);
            return I3.buffer || (I3 = new Uint8Array(I3)), G(I3.buffer), I3;
          }, process.argv.length > 1 && process.argv[1].replace(/\\/g, "/"), e = process.argv.slice(2), A2.exports = Q2, process.on("uncaughtException", function(A3) {
            if (!(A3 instanceof V)) throw A3;
          }), process.on("unhandledRejection", u), Q2.inspect = function() {
            return "[Emscripten Module object]";
          }) : D ? ("undefined" != typeof read && (n = function(A3) {
            return read(A3);
          }), a = function(A3) {
            var I3;
            return "function" == typeof readbuffer ? new Uint8Array(readbuffer(A3)) : (G("object" == typeof (I3 = read(A3, "binary"))), I3);
          }, "undefined" != typeof scriptArgs ? e = scriptArgs : void 0 !== arguments && (e = arguments), "undefined" != typeof print && ("undefined" == typeof console && (console = {}), console.log = print, console.warn = console.error = "undefined" != typeof printErr ? printErr : print)) : (E || i) && (i ? y = self.location.href : "undefined" != typeof document && document.currentScript && (y = document.currentScript.src), y = 0 !== y.indexOf("blob:") ? y.substr(0, y.lastIndexOf("/") + 1) : "", n = function(A3) {
            var I3 = new XMLHttpRequest();
            return I3.open("GET", A3, false), I3.send(null), I3.responseText;
          }, i && (a = function(A3) {
            var I3 = new XMLHttpRequest();
            return I3.open("GET", A3, false), I3.responseType = "arraybuffer", I3.send(null), new Uint8Array(I3.response);
          }), t = function(A3, I3, g3) {
            var B3 = new XMLHttpRequest();
            B3.open("GET", A3, true), B3.responseType = "arraybuffer", B3.onload = function() {
              200 == B3.status || 0 == B3.status && B3.response ? I3(B3.response) : g3();
            }, B3.onerror = g3, B3.send(null);
          }), Q2.print || console.log.bind(console);
          var F, c, w = Q2.printErr || console.warn.bind(console);
          for (B2 in C) C.hasOwnProperty(B2) && (Q2[B2] = C[B2]);
          C = null, Q2.arguments && (e = Q2.arguments), Q2.thisProgram && Q2.thisProgram, Q2.quit && Q2.quit, Q2.wasmBinary && (F = Q2.wasmBinary), Q2.noExitRuntime, "object" != typeof WebAssembly && u("no native wasm support detected");
          var h = false;
          function G(A3, I3) {
            A3 || u("Assertion failed: " + I3);
          }
          var N, R, f = "undefined" != typeof TextDecoder ? new TextDecoder("utf8") : void 0;
          function U(A3) {
            N = A3, Q2.HEAP8 = new Int8Array(A3), Q2.HEAP16 = new Int16Array(A3), Q2.HEAP32 = new Int32Array(A3), Q2.HEAPU8 = R = new Uint8Array(A3), Q2.HEAPU16 = new Uint16Array(A3), Q2.HEAPU32 = new Uint32Array(A3), Q2.HEAPF32 = new Float32Array(A3), Q2.HEAPF64 = new Float64Array(A3);
          }
          Q2.INITIAL_MEMORY;
          var M, Y = [], S = [], H = [], d = 0, k = null, J = null;
          function u(A3) {
            throw Q2.onAbort && Q2.onAbort(A3), w(A3 += ""), h = true, A3 = "abort(" + A3 + "). Build with -s ASSERTIONS=1 for more info.", new WebAssembly.RuntimeError(A3);
          }
          function p(A3) {
          ...
          Q2.preloadedImages = {}, Q2.preloadedAudios = {};
          var l, K = "argon2.wasm";
          function q(A3) {
            try {
              if (A3 == K && F) return new Uint8Array(F);
              if (a) return a(A3);
          ...
          function b(A3) {
            for (; A3.length > 0; ) {
              ...
              if ("function" != typeof I3) {
                var g3 = I3.func;
                "number" == typeof g3 ? void 0 === I3.arg ? M.get(g3)() : M.get(g3)(I3.arg) : g3(void 0 === I3.arg ? null : I3.arg);
              } else I3(Q2);
            }
          }
          function x(A3) {
            try {
              return c.grow(A3 - N.byteLength + 65535 >>> 16), U(c.buffer), 1;
            } catch (A4) {
            }
          }
          p(K) || (l = K, K = Q2.locateFile ? Q2.locateFile(l, y) : y + l);
          var m, X = { a: function(A3, I3, g3) {
            R.copyWithin(A3, I3, I3 + g3);
          }, b: function(A3) {
            var I3, g3 = R.length, B3 = 2147418112;
            if ((A3 >>>= 0) > B3) return false;
            for (var Q3 = 1; Q3 <= 4; Q3 *= 2) {
              var C2 = g3 * (1 + 0.2 / Q3);
              if (C2 = Math.min(C2, A3 + 100663296), x(Math.min(B3, ((I3 = Math.max(A3, C2)) % 65536 > 0 && (I3 += 65536 - I3 % 65536), I3)))) return true;
            }
            return false;
          } }, W = (function() {
            var A3 = { a: X };
            function I3(A4, I4) {
              var g4, B4 = A4.exports;
              Q2.asm = B4, U((c = Q2.asm.c).buffer), M = Q2.asm.k, g4 = Q2.asm.d, S.unshift(g4), function(A5) {
                if (d--, Q2.monitorRunDependencies && Q2.monitorRunDependencies(d), 0 == d && (null !== k && (clearInterval(k), k = null), J)) {
                  var I5 = J;
                  J = null, I5();
                }
              }();
            ...
            function B3(I4) {
              return function() {
                if (!F && (E || i)) {
                  if ("function" == typeof fetch && !L(K)) return fetch(K, { credentials: "same-origin" }).then(function(A4) {
                    if (!A4.ok) throw "failed to load wasm binary file at '" + K + "'";
                    return A4.arrayBuffer();
                  }).catch(function() {
                    return q(K);
                  });
                  if (t) return new Promise(function(A4, I5) {
                    t(K, function(I6) {
                      A4(new Uint8Array(I6));
                    }, I5);
                  });
                }
                ...
                return WebAssembly.instantiate(I5, A3);
              }).then(I4, function(A4) {
                w("failed to asynchronously prepare wasm: " + A4), u(A4);
              });
            }
            if (d++, Q2.monitorRunDependencies && Q2.monitorRunDependencies(d), Q2.instantiateWasm) try {
              return Q2.instantiateWasm(A3, I3);
            } catch (A4) {
              return w("Module.instantiateWasm callback failed with error: " + A4), false;
            }
            F || "function" != typeof WebAssembly.instantiateStreaming || p(K) || L(K) || "function" != typeof fetch ? B3(g3) : fetch(K, { credentials: "same-origin" }).then(function(I4) {
              return WebAssembly.instantiateStreaming(I4, A3).then(g3, function(A4) {
                return w("wasm streaming compile failed: " + A4), w("falling back to ArrayBuffer instantiation"), B3(g3);
              });
            });
          }(), Q2.___wasm_call_ctors = function() {
            return (Q2.___wasm_call_ctors = Q2.asm.d).apply(null, arguments);
          }, Q2._argon2_hash = function() {
            return (Q2._argon2_hash = Q2.asm.e).apply(null, arguments);
          }, Q2._malloc = function() {
            return (W = Q2._malloc = Q2.asm.f).apply(null, arguments);
          }), T = (Q2._free = function() {
            return (Q2._free = Q2.asm.g).apply(null, arguments);
          }, Q2._argon2_verify = function() {
            return (Q2._argon2_verify = Q2.asm.h).apply(null, arguments);
          }, Q2._argon2_error_message = function() {
            return (Q2._argon2_error_message = Q2.asm.i).apply(null, arguments);
          }, Q2._argon2_encodedlen = function() {
            return (Q2._argon2_encodedlen = Q2.asm.j).apply(null, arguments);
          }, Q2._argon2_hash_ext = function() {
            return (Q2._argon2_hash_ext = Q2.asm.l).apply(null, arguments);
          }, Q2._argon2_verify_ext = function() {
            return (Q2._argon2_verify_ext = Q2.asm.m).apply(null, arguments);
          }, Q2.stackAlloc = function() {
            return (T = Q2.stackAlloc = Q2.asm.n).apply(null, arguments);
          });
          function V(A3) {
          ...
          function j(A3) {
            function I3() {
              m || (m = true, Q2.calledRun = true, h || (b(S), Q2.onRuntimeInitialized && Q2.onRuntimeInitialized(), function() {
                if (Q2.postRun) for ("function" == typeof Q2.postRun && (Q2.postRun = [Q2.postRun]); Q2.postRun.length; ) A4 = Q2.postRun.shift(), H.unshift(A4);
                var A4;
                b(H);
              }()));
            }
            A3 = A3 || e, d > 0 || (function() {
              if (Q2.preRun) for ("function" == typeof Q2.preRun && (Q2.preRun = [Q2.preRun]); Q2.preRun.length; ) A4 = Q2.preRun.shift(), Y.unshift(A4);
              var A4;
              b(Y);
            }(), d > 0 || (Q2.setStatus ? (Q2.setStatus("Running..."), setTimeout(function() {
              setTimeout(function() {
                Q2.setStatus("");
              }, 1), I3();
            }, 1)) : I3()));
          }
          if (Q2.allocate = function(A3, I3) {
            var g3;
            return g3 = 1 == I3 ? T(A3.length) : W(A3.length), A3.subarray || A3.slice ? R.set(A3, g3) : R.set(new Uint8Array(A3), g3), g3;
          }, Q2.UTF8ToString = function(A3, I3) {
            return A3 ? function(A4, I4, g3) {
              for (var B3 = I4 + g3, Q3 = I4; A4[Q3] && !(Q3 >= B3); ) ++Q3;
              if (Q3 - I4 > 16 && A4.subarray && f) return f.decode(A4.subarray(I4, Q3));
              for (var C2 = ""; I4 < Q3; ) {
                var E2 = A4[I4++];
                if (128 & E2) {
                  var i2 = 63 & A4[I4++];
                  if (192 != (224 & E2)) {
                    var o2 = 63 & A4[I4++];
                    if ((E2 = 224 == (240 & E2) ? (15 & E2) << 12 | i2 << 6 | o2 : (7 & E2) << 18 | i2 << 12 | o2 << 6 | 63 & A4[I4++]) < 65536) C2 += String.fromCharCode(E2);
                    else {
                      var D2 = E2 - 65536;
                      C2 += String.fromCharCode(55296 | D2 >> 10, 56320 | 1023 & D2);
                    }
                  } else C2 += String.fromCharCode((31 & E2) << 6 | i2);
                } else C2 += String.fromCharCode(E2);
              }
              return C2;
            }(R, A3, I3) : "";
          }, Q2.ALLOC_NORMAL = 0, J = function A3() {
            m || j(), m || (J = A3);
          }, Q2.run = j, Q2.preInit) for ("function" == typeof Q2.preInit && (Q2.preInit = [Q2.preInit]); Q2.preInit.length > 0; ) Q2.preInit.pop()();
          j(), A2.exports = Q2, Q2.unloadRuntime = function() {
            "undefined" != typeof self && delete self.Module, Q2 = c = M = N = R = void 0, delete A2.exports;
          };
        }, 631: function(A2, I2, g2) {
          var B2, Q2;
          "undefined" != typeof self && self, void 0 === (Q2 = "function" == typeof (B2 = function() {
            const A3 = "undefined" != typeof self ? self : this, I3 = { Argon2d: 0, Argon2i: 1, Argon2id: 2 };
            function B3(I4) {
              if (B3._promise) return B3._promise;
              if (B3._module) return Promise.resolve(B3._module);
              let C2;
              return C2 = A3.process && A3.process.versions && A3.process.versions.node ? Q3().then((A4) => new Promise((I5) => {
                A4.postRun = () => I5(A4);
              })) : (A3.loadArgon2WasmBinary ? A3.loadArgon2WasmBinary() : Promise.resolve(g2(721)).then((A4) => function(A5) {
                const I5 = atob(A5), g3 = new Uint8Array(new ArrayBuffer(I5.length));
                for (let A6 = 0; A6 < I5.length; A6++) g3[A6] = I5.charCodeAt(A6);
                return g3;
              }(A4))).then((g3) => function(I5, g4) {
                return new Promise((B4) => (A3.Module = { wasmBinary: I5, wasmMemory: g4, postRun() {
                  B4(Module);
                } }, Q3()));
              }(g3, I4 ? function(A4) {
                const I5 = 1024, g4 = 64 * I5, B4 = (1024 * I5 * 1024 * 2 - 64 * I5) / g4, Q4 = Math.min(Math.max(Math.ceil(A4 * I5 / g4), 256) + 256, B4);
                return new WebAssembly.Memory({ initial: Q4, maximum: B4 });
              }(I4) : void 0)), B3._promise = C2, C2.then((A4) => (B3._module = A4, delete B3._promise, A4));
            }
            function Q3() {
              return A3.loadArgon2WasmModule ? A3.loadArgon2WasmModule() : Promise.resolve(g2(773));
            }
            function C(A4, I4) {
              return A4.allocate(I4, "i8", A4.ALLOC_NORMAL);
            }
            function E(A4, I4) {
              return C(A4, new Uint8Array([...I4, 0]));
            }
            function i(A4) {
              if ("string" != typeof A4) return A4;
              if ("function" == typeof TextEncoder) return new TextEncoder().encode(A4);
              if ("function" == typeof Buffer) return Buffer.from(A4);
              throw new Error("Don't know how to encode UTF8");
            }
            return { ArgonType: I3, hash: function(A4) {
              const g3 = A4.mem || 1024;
              return B3(g3).then((B4) => {
                const Q4 = A4.time || 1, o = A4.parallelism || 1, D = i(A4.pass), e = E(B4, D), n = D.length, t = i(A4.salt), a = E(B4, t), r = t.length, s = A4.type || I3.Argon2d, y = B4.allocate(new Array(A4.hashLen || 24), "i8", B4.ALLOC_NORMAL), F = A4.secret ? C(B4, A4.secret) : 0, c = A4.secret ? A4.secret.byteLength : 0, w = A4.ad ? C(B4, A4.ad) : 0, h = A4.ad ? A4.ad.byteLength : 0, G = A4.hashLen || 24, N = B4._argon2_encodedlen(Q4, g3, o, r, G, s), R = B4.allocate(new Array(N + 1), "i8", B4.ALLOC_NORMAL);
                let f, U, M;
                try {
                  U = B4._argon2_hash_ext(Q4, g3, o, e, n, a, r, y, G, R, N, s, F, c, w, h, 19);
                } catch (A5) {
                  f = A5;
                }
                if (0 !== U || f) {
                  try {
                    f || (f = B4.UTF8ToString(B4._argon2_error_message(U)));
                  } catch (A5) {
                  }
                  M = { message: f, code: U };
                } else {
                  let A5 = "";
                  const I4 = new Uint8Array(G);
                  for (let g4 = 0; g4 < G; g4++) {
                    const Q5 = B4.HEAP8[y + g4];
                    I4[g4] = Q5, A5 += ("0" + (255 & Q5).toString(16)).slice(-2);
                  }
                  M = { hash: I4, hashHex: A5, encoded: B4.UTF8ToString(R) };
                }
                try {
                  B4._free(e), B4._free(a), B4._free(y), B4._free(R), w && B4._free(w), F && B4._free(F);
                } catch (A5) {
                }
                if (f) throw M;
                return M;
              ...
              return B3().then((g3) => {
                const B4 = i(A4.pass), Q4 = E(g3, B4), o = B4.length, D = A4.secret ? C(g3, A4.secret) : 0, e = A4.secret ? A4.secret.byteLength : 0, n = A4.ad ? C(g3, A4.ad) : 0, t = A4.ad ? A4.ad.byteLength : 0, a = E(g3, i(A4.encoded));
                let r, s, y, F = A4.type;
                if (void 0 === F) {
                  let g4 = A4.encoded.split("$")[1];
                  g4 && (g4 = g4.replace("a", "A"), F = I3[g4] || I3.Argon2d);
                }
                try {
                  s = g3._argon2_verify_ext(a, Q4, o, D, e, n, t, F);
                } catch (A5) {
                  r = A5;
                }
                if (s || r) {
                  try {
                    r || (r = g3.UTF8ToString(g3._argon2_error_message(s)));
                  } catch (A5) {
                  }
                  y = { message: r, code: s };
                }
                try {
                  g3._free(Q4), g3._free(a);
                } catch (A5) {
                }
                if (r) throw y;
                return y;
        ...
        function Q(A2) {
          ...
          var C = B[A2] = { exports: {} };
          return g[A2].call(C.exports, C, C.exports, Q), C.exports;
        }
        return I = Object.getPrototypeOf ? (A2) => Object.getPrototypeOf(A2) : (A2) => A2.__proto__, Q.t = function(g2, B2) {
          if (1 & B2 && (g2 = this(g2)), 8 & B2) return g2;
          if ("object" == typeof g2 && g2) {
            if (4 & B2 && g2.__esModule) return g2;
            if (16 & B2 && "function" == typeof g2.then) return g2;
          }
          var C = /* @__PURE__ */ Object.create(null);
          Q.r(C);
          var E = {};
          A = A || [null, I({}), I([]), I(I)];
          for (var i = 2 & B2 && g2; "object" == typeof i && !~A.indexOf(i); i = I(i)) Object.getOwnPropertyNames(i).forEach((A2) => E[A2] = () => g2[A2]);
          return E.default = () => g2, Q.d(C, E), C;
        }, Q.d = (A2, I2) => {
          for (var g2 in I2) Q.o(I2, g2) && !Q.o(A2, g2) && Object.defineProperty(A2, g2, { enumerable: true, get: I2[g2] });
        }, Q.o = (A2, I2) => Object.prototype.hasOwnProperty.call(A2, I2), Q.r = (A2) => {
...
export default require_argon2_bundled_min();
//# sourceMappingURL=argon2-browser_dist_argon2-bundled__min__js.js.map
