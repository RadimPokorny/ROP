...
var C = [1332899944, 1700884034, 1701343084, 1684370003, 1668446532, 1869963892];
var S = (n, r) => {
  if (r <= 0 || r > n.length)
...
function d(n, r, o, t) {
  ...
  const s = parseInt(r.substring(l, l + 1), 10) * 10, h = parseInt(r.substring(l + 1, l + 2), 10), u = s + h, i = r.substring(l + 3, l + 25);
  n += e >= "a" ? "\0" : "";
  const p = k(n), g = O(i, 16), c = (a) => {
    const y = [];
  ...
  return o === false ? R(p, g, u, false, t).then((a) => c(a)) : c(R(p, g, u, true, t));
}
var U = (n, r = 10) => {
