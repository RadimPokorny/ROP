...
var w = (n) => Array(n).fill(-1);
var E = [...w(46), 0, 1, ...I.slice(54, 64), ...w(7), ...I.slice(2, 28), ...w(6), ...I.slice(28, 54), ...w(5)];
...
var f = typeof process == "object" && process.env.NEXT_RUNTIME === "edge" ? setTimeout : typeof setImmediate == "function" ? setImmediate : typeof process == "object" && typeof process.nextTick == "function" ? process.nextTick : setTimeout;
var k = (n) => {
  let r = 0;
  const o = [];
...
var R = (n, r, o, t, e) => {
  ...
  const g = () => {
    ...
    if (t === false) return new Promise((c) => f(() => {
      g().then(c);
    }));
  };
  if (t === false) return g();
...
function m(n, r, o, t) {
  if (typeof n != "string" || typeof r != "string") {
    ...
    if (o === false) return Promise.reject(p);
    throw p;
  }
  let e, s;
...
var P = function(n, r, o) {
  return typeof n == "string" && typeof r == "number" ? U(r).then((t) => m(n, t, false, o)) : typeof n == "string" && typeof r == "string" ? m(n, r, false, o) : Promise.reject(new Error(`Illegal arguments: ${typeof n}, ${typeof r}`));
};
var x = (n, r) => {
  if (typeof n != "string" || typeof r != "string") throw Error("Illegal arguments: " + typeof n + ", " + typeof r);
  return r.length !== 60 ? false : $(n, r.substring(0, r.length - 31)) === r;
};
